# -*- coding: utf-8 -*-
#
# systemd-logging documentation build configuration file.
#
...
from systemdlogging import VERSION
...
project = u'systemd-logging'
copyright = u'2019-2020, Igor `idle sign` Starikov'
...
htmlhelp_basename = 'systemd-loggingdoc'
...
latex_documents = [
  ('index', 'systemd-logging.tex', u'systemd-logging Documentation',
...
man_pages = [
    ('index', 'systemd-logging', u'systemd-logging Documentation',
